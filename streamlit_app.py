...
# --- 2. 페이지 타이틀 ---
st.title("성현의 첫번째 페이지")
st.subheader("춘천reamlit_app.py 만들고 다음 내용 복붙해서 집어넣기
...
with col2:
    st.write("유튜브 동영상 예제")
    st.video("https://www.youtube.com/watch?v=Km__cJEJ3JI&list=RDKm__cJEJ3JI&start_radio=1")
